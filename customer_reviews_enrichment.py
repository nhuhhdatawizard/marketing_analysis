...
def fetch_data_from_sql():
    ...
    conn_str = (
        ...
        "Server=HungLo67\\SQLEXPRESS;"  # Specify your SQL Server instance
...
# customer_reviews_df.to_csv('fact_customer_reviews_with_sentiment-v1.csv', index=False)
customer_reviews_df.to_csv(r'C:\Users\hoang\Desktop\fact_customer_reviews_with_sentiment-v1.csv', index=False)
